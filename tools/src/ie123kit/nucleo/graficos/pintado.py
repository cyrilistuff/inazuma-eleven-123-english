"""Pintado de rótulos en atlas CTPK sin salirse del rectángulo indicado.

Cada operación declara su rectángulo ('box'); el texto se ajusta dentro o se
rechaza con ValueError. La fuente TrueType es un parámetro obligatorio: este
módulo no fija ninguna ruta por defecto.
"""
from PIL import ImageDraw, ImageFont

__all__ = ["paint", "paint_condensed"]
