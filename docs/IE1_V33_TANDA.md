...
(issues #25–#30). Cada línea se preparó en `work/ie1/capas/v33/<línea>/` a partir de copias de
los archivos base (`work/ie1/capas/v33/base/{orig,v32}`), con un implementador, una revisión
adversarial y hasta dos rondas de corrección. El mapa de propiedad
`work/ie1/capas/v33/ownership.json` impide que dos líneas toquen el mismo archivo (403 archivos,
0 solapes). Tipografía v20 bloqueada: el bloqueo pasa en todas las líneas.

## Contenido

1. **Partidos de historia** (#25, `mch.pkh/pkb`, `work/ie1/capas/v33/mch_story`): 4.628 registros
...
2. **Rótulos y objetivos** (#26, `eve.pkb`, `work/ie1/capas/v33/eve_labels`): 336 registros en
...
3. **Literales del CRO** (#27, `ina_main1.cro`, `work/ie1/capas/v33/cro`): 155 textos visibles
...
4. **Datos** (#28, `work/ie1/capas/v33/data`): 36 títulos (`rpgtitle.STR`), 89 textos de
...
8. **Título del icono** (G13, `work/ie1/capas/v33/smdh`): SMDH con título español preparado
   (variantes `es` y `es_en`); no forma parte de `archive.fa` y no se instala por
   defecto (ver `work/ie1/capas/v33/smdh/report.json`).

Correcciones finales del coordinador (`work/ie1/capas/v33/_final/patch_residual.py`): restos de
...
- **Auditoría de texturas ya cambiadas** (`work/ie1/capas/v33/tex_residual/report.json`): 98
...
2026-09-11: candidata `work/shared/candidatas/probe_ie1_v33/archive.fa` generada e **instalada** en
...
- Validación por línea (`work/ie1/capas/v33/_final/validate.log`): PASS en todas. `tex_help_3`
  falla solo en tt52 por el parche declarado del coordinador (su validación previa
  al parche pasó con los mismos archivos).
- Limpieza: se borró `work/shared/candidatas/probe_ie1_v31/archive.fa`; v32 se conserva como base.
...
```text
python work/ie1/capas/v33/mch_story/apply.py && python work/ie1/capas/v33/mch_story/validate.py
python work/ie1/capas/v33/eve_labels/validate.py
python work/ie1/capas/v33/cro/validate.py
python work/ie1/capas/v33/data/validate.py
python work/ie1/capas/v33/gamestring/validate.py
python work/ie1/capas/v33/ie99_menu/validate.py
python work/ie1/capas/v33/<tex_*>/validate.py
python work/ie1/capas/v33/_final/patch_residual.py
python tools/build_ui_revision.py --base work/shared/candidatas/probe_ie1_v32/archive.fa --ui work/ie1/capas/v33/eve_labels --output work/shared/candidatas/probe_ie1_v33/archive.fa --extra work/ie1/capas/v33/mch_story/extra --extra work/ie1/capas/v33/data/extra --extra work/ie1/capas/v33/gamestring/extra --extra work/ie1/capas/v33/ie99_menu/extra --extra work/ie1/capas/v33/tex_banners3d/extra --extra work/ie1/capas/v33/tex_demo_bg/extra --extra work/ie1/capas/v33/tex_game/extra --extra work/ie1/capas/v33/tex_help_1/extra --extra work/ie1/capas/v33/tex_help_2/extra --extra work/ie1/capas/v33/tex_help_3/extra --extra work/ie1/capas/v33/tex_help_4/extra --extra work/ie1/capas/v33/tex_menus_a/extra --extra work/ie1/capas/v33/tex_menus_b/extra --extra work/ie1/capas/v33/tex_misc/extra --extra work/ie1/capas/v33/tex_schools/extra --extra work/ie1/capas/v33/tex_staffroll/extra --cro work/ie1/capas/v33/cro/romfs/cro/ina_main1.cro
python tools/verify_candidate.py --base work/shared/candidatas/probe_ie1_v32 --candidate work/shared/candidatas/probe_ie1_v33 --events work/ie1/capas/v33/eve_labels/events --literals work/ie1/capas/v33/_final/cro_literals_v33.json --layer (las mismas 16 capas)
python work/ie1/legacy/vs_revision/install.py work/shared/candidatas/probe_ie1_v33
```
