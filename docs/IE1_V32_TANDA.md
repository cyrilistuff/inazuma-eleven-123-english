...
extraída en `work/ie1/fuentes/nds_es/` (datos) y, para los textos del ejecutable, ARM9 descomprimido
con `tools/blz.py` en `work/ie1/fuentes/nds_es/bin/` (1.483 cadenas, solo local).
Tipografía v20 bloqueada: el bloqueo pasa en todos los pasos.

## Contenido

1. **Textos cortos de datos** (`work/ie1/legacy/misc_revision/apply.py`):
...
2. **Futblog** (`blogpost.dat`, `blogres.dat`; `work/ie1/legacy/blog_revision`): 108 títulos,
   ...
   conserva).
3. **Pantallas restantes** (`work/ie1/legacy/screens2_revision`, 30 texturas): fin de partido
...
2026-09-11: candidata `work/shared/candidatas/probe_ie1_v32/archive.fa` generada e **instalada** en
...
- Limpieza: se borró `work/shared/candidatas/probe_ie1_v30/archive.fa`; v31 se conserva como base.
...
```text
python work/ie1/legacy/misc_revision/apply.py
python work/ie1/legacy/blog_revision/build_worklist.py
python work/ie1/legacy/blog_revision/check.py work/ie1/legacy/blog_revision/chunk_0*.json
python work/ie1/legacy/blog_revision/apply.py
python work/ie1/legacy/screens2_revision/prepare.py
python tools/translate_ui_textures.py work/ie1/legacy/screens2_revision/manifest.json --source work/ie1/legacy/screens2_revision/base --base work/ie1/legacy/screens2_revision/base --output work/ie1/legacy/screens2_revision/extra --previews work/ie1/legacy/screens2_revision/previews
python work/ie1/legacy/menu_revision/validate.py work/ie1/legacy/screens2_revision
python tools/build_ui_revision.py --base work/shared/candidatas/probe_ie1_v31/archive.fa --ui work/ie1/legacy/misc_revision --extra work/ie1/legacy/misc_revision/extra --extra work/ie1/legacy/blog_revision/extra --extra work/ie1/legacy/screens2_revision/extra --cro work/shared/candidatas/probe_ie1_v31/romfs/cro/ina_main1.cro --output work/shared/candidatas/probe_ie1_v32/archive.fa
python tools/verify_candidate.py --base work/shared/candidatas/probe_ie1_v31 --candidate work/shared/candidatas/probe_ie1_v32 --layer work/ie1/legacy/misc_revision/extra --layer work/ie1/legacy/blog_revision/extra --layer work/ie1/legacy/screens2_revision/extra
python work/ie1/legacy/vs_revision/install.py work/shared/candidatas/probe_ie1_v32
```
